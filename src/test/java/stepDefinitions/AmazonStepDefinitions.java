...
public class AmazonStepDefinitions {
    ...
    @Given("sonuclarin {string} icrdigini test eder")
    public void sonuclarin_icrdigini_test_eder(String istenenKelime) {
    ...
    @Given("kullanici {string} anasayfasindan")
    public void kullaniciAnasayfasindan(String istenenUrl) {
